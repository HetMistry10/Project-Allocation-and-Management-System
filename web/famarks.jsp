...
%>           
 ...
 <br>
 <br>
 Select Review : <select  class="selectsem" name="fmarkreview" style="" required=""><option disabled selected value> -- select a review -- </option>
...
<option value="R3">Review 3</option>
    ...
    <br><br>             
       Enter marks :  <input class="text" type="number" name="fmarks" required placeholder="Enter marks" min="0" required/>
